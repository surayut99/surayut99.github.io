function editHeadCell() {
    var th = document.getElementsByTagName("th")
    var dictColor = {
        "Sunday": "rgb(229, 28, 35,.8)", "Monday": "rgb(255, 255, 0,.8)", "Tuesday": "rgb(253, 159, 253,.8)", "Wednesday": "rgb(102, 204, 102,.8)",
        "Thursday": "rgb(255, 153, 0,.8)", "Friday": "rgb(102, 153, 255,.8)", "Saturday": "rgb(153, 106, 183, .8)"
    }
    ...
    for (var i = 11; i < 18; i++) {
        ...
        th[i].addEventListener('click', function () { showSubjectList(this) })
    }
}
